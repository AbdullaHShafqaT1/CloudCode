...
- Report compiled: 2026-09-21T11:00:59.258549+00:00.
...
- Repository HEAD: `4ef7be127ecb9442b1650615ed3c234087be70e2`. The checkout already contained Steps 1–3 changes and user changes; HEAD alone does not describe the tested tree. Initial working-tree inventory is in [preflight.json](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/preflight.json>).
...
- Configuration preserved: `orchestrator_config.json` SHA-256 before and after is `fe68f9054e01c64c948c3a89233aba44913c145a991c5037b677b7dfe393bb88`. Saved configuration was not rewritten; endpoint/model/cache overrides were confined to benchmark invocation. Existing saved values remain unchanged.
- Isolated output directory: `C:\Users\Acer\Desktop\projects\LEGACYStudios\cloud Bridge Projects\CloudCode\benchmark_outputs\step4-20260921-1156`. Separate generated workspaces: `control`, `control-retest`, and `chess` beneath it. No existing application project was overwritten.

The earlier unavailable-endpoint preflight and report are preserved under `C:\Users\Acer\Desktop\projects\LEGACYStudios\cloud Bridge Projects\CloudCode\benchmark_outputs\step4-20260921-1107`. The intermediate model-mismatch preflight is also preserved. No benchmark was run against an unavailable endpoint or silently substituted model.

## C. Control task

Exact frozen prompt: [control-prompt.txt](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-prompt.txt>). The task was a standard-library Integer Summary CLI: a callable `summarize` function, nonempty list/tuple of integers excluding booleans, exact count/total/mean/minimum/maximum result, input preservation, JSON CLI output, useful invalid-input behavior, genuine unit tests, README, and running guide. `app_gui.py` was explicitly designated the CLI presentation module to accommodate the existing workflow's fixed Python profile; no control GUI was claimed.
...
Exact frozen prompt: [chess-prompt.txt](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/chess-prompt.txt>). One specification was submitted, followed by 9 live responses and automatic workflow feedback. No human application repair was inserted between responses.
...
|---:|---|---|---|
| 1 | Correct initial pieces and squares | NOT TESTED | Engine import failed before behavior could run. |
| 2 | Legal movement of each piece | NOT TESTED | Engine import failed before behavior could run. |
| 3 | Turn enforcement | NOT TESTED | Engine import failed before behavior could run. |
| 4 | Illegal move rejection | NOT TESTED | Engine import failed before behavior could run. |
| 5 | Captures update board | NOT TESTED | Engine import failed before behavior could run. |
| 6 | King cannot move into check | NOT TESTED | Engine import failed before behavior could run. |
| 7 | Pinned piece cannot expose king | NOT TESTED | Engine import failed before behavior could run. |
| 8 | Check detection | NOT TESTED | Engine import failed before behavior could run. |
| 9 | Checkmate detection | NOT TESTED | Engine import failed before behavior could run. |
| 10 | Stalemate detection | NOT TESTED | Engine import failed before behavior could run. |
| 11 | Legal castling | NOT TESTED | Engine import failed before behavior could run. |
| 12 | Prohibited castling rejected | NOT TESTED | Engine import failed before behavior could run. |
| 13 | Legal en passant | NOT TESTED | Engine import failed before behavior could run. |
| 14 | Unavailable en passant rejected | NOT TESTED | Engine import failed before behavior could run. |
| 15 | Promotion applies selected piece | NOT TESTED | Engine import failed before behavior could run. |
| 16 | New game resets position and state | NOT TESTED | Engine import failed before behavior could run. |
| 17 | Complete two-player GUI sequence | NOT TESTED | Actual launch exited 1 before browser interaction. |
...
- [STEP4_LIVE_BENCHMARK_REPORT.md](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/STEP4_LIVE_BENCHMARK_REPORT.md>)
- [preflight.json](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/preflight.json>)
- [preflight.log](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/preflight.log>)
- [preflight-model-mismatch.json](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/preflight-model-mismatch.json>)
- [preflight-model-mismatch.log](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/preflight-model-mismatch.log>)
- [control-prompt.txt](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-prompt.txt>)
- [chess-prompt.txt](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/chess-prompt.txt>)
- [control_acceptance.py](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control_acceptance.py>)
- [chess_acceptance.py](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/chess_acceptance.py>)
- [run_live.py](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/run_live.py>)
- [independent_check.py](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/independent_check.py>)
- [final_diagnostics.py](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/final_diagnostics.py>)
- [final-diagnostics.json](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/final-diagnostics.json>)
- [evidence-summary.json](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/evidence-summary.json>)
- [parser-regressions.log](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/parser-regressions.log>)
- [chess-launch.log](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/chess-launch.log>)
- [chess-required-launch.log](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/chess-required-launch.log>)

### control

- Generated workspace: [control](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control>)
- NodeCore run record: [2e4e2abfa75e4f45ac01606f2013f594.json](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control/.cloudcode/runs/2e4e2abfa75e4f45ac01606f2013f594.json>)
- [control-live.log](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-live.log>)
- [control-http.jsonl](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-http.jsonl>)
- [control-events.jsonl](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-events.jsonl>)
- [control-metadata.json](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-metadata.json>)
- [control-result.json](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-result.json>)
- [control-independent-final.json](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-independent-final.json>)
- [control-independent-final.log](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-independent-final.log>)
- [control-generated-tests.json](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-generated-tests.json>)
- [control-generated-tests.log](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-generated-tests.log>)

Final deliverable SHA-256 values (also match independent before/after snapshots):

| File | SHA-256 |
|---|---|
| [app_gui.py](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control/app_gui.py>) | `32cf86d34739fd0bda295b6d185be7d2f00917f177a7d49bf29a559f2de5ff76` |
| [app_logic.py](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control/app_logic.py>) | `2742ee53548fdf9ce79b01c2a34dd4816f8500f5386a5da52cfd498ed9e82854` |
| [main.py](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control/main.py>) | `af5aabf2d37afe1f41285ad4a7aa2d75045af8a5230cdbcf2d779e4ea1c2818a` |
| [test_app.py](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control/test_app.py>) | `770446bae346079cfadbf02c334850bc3e0f74a5c39590968490641d05cb5828` |

### control-retest

- Generated workspace: [control-retest](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-retest>)
- NodeCore run record: [04577e8a5aff422e9f9f6163d6dd0c7a.json](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-retest/.cloudcode/runs/04577e8a5aff422e9f9f6163d6dd0c7a.json>)
- [control-retest-live.log](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-retest-live.log>)
- [control-retest-http.jsonl](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-retest-http.jsonl>)
- [control-retest-events.jsonl](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-retest-events.jsonl>)
- [control-retest-metadata.json](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-retest-metadata.json>)
- [control-retest-result.json](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-retest-result.json>)
- [control-retest-independent-final.json](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-retest-independent-final.json>)
- [control-retest-independent-final.log](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-retest-independent-final.log>)
- [control-retest-generated-tests.json](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-retest-generated-tests.json>)
- [control-retest-generated-tests.log](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-retest-generated-tests.log>)

Final deliverable SHA-256 values (also match independent before/after snapshots):

| File | SHA-256 |
|---|---|
| [app_gui.py](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-retest/app_gui.py>) | `32cf86d34739fd0bda295b6d185be7d2f00917f177a7d49bf29a559f2de5ff76` |
| [app_logic.py](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-retest/app_logic.py>) | `6bbb1a5bc835469a4699a526b270721236b130cd22d87f4fcee293b8f191ece1` |
| [main.py](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-retest/main.py>) | `af5aabf2d37afe1f41285ad4a7aa2d75045af8a5230cdbcf2d779e4ea1c2818a` |
| [test_app.py](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/control-retest/test_app.py>) | `d8e7fba2400286332bef2c688238bbd8772ec64a01b2d6af9dbac4f12c4d3cd5` |

### chess

- Generated workspace: [chess](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/chess>)
- NodeCore run record: [ee5cd40928be4337992e589534478e4b.json](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/chess/.cloudcode/runs/ee5cd40928be4337992e589534478e4b.json>)
- [chess-live.log](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/chess-live.log>)
- [chess-http.jsonl](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/chess-http.jsonl>)
- [chess-events.jsonl](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/chess-events.jsonl>)
- [chess-metadata.json](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/chess-metadata.json>)
- [chess-result.json](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/chess-result.json>)
- [chess-independent-final.json](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/chess-independent-final.json>)
- [chess-independent-final.log](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/chess-independent-final.log>)
- [chess-generated-tests.json](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/chess-generated-tests.json>)
- [chess-generated-tests.log](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/chess-generated-tests.log>)

Final deliverable SHA-256 values (also match independent before/after snapshots):

| File | SHA-256 |
|---|---|
| [chess_gui.py](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/chess/chess_gui.py>) | `de6f56bbd1d20afae093a66dfd5b3d442ce900147570b4cc252c078af8721cec` |
| [chess_logic.py](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/chess/chess_logic.py>) | `033f4af5317ad2d1033e8c29c92c8aabd50038a6b3662483bba0c0c2e25a42ab` |
| [main.py](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/chess/main.py>) | `a3517518f5bcdd34d5893c45bbbb1afd6519802458a4b1d100748e53d276e909` |
| [RunningGUIDE.txt](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1156/chess/RunningGUIDE.txt>) | `76e459528493a4abc235a24f0dd6d44131e9e8049f626810dac03e982e193809` |

### Source changes and preserved earlier report

- [NodeCore/node_core/agents.py](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/NodeCore/node_core/agents.py>)
- [NodeCore/node_core/workflow.py](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/NodeCore/node_core/workflow.py>)
- [NodeCore/test_document_fences.py](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/NodeCore/test_document_fences.py>)
- [STEP3_REPORT.md](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/STEP3_REPORT.md>)
- [Earlier unavailable-endpoint report](<C:/Users/Acer/Desktop/projects/LEGACYStudios/cloud Bridge Projects/CloudCode/benchmark_outputs/step4-20260921-1107/STEP4_LIVE_BENCHMARK_REPORT.md>)
